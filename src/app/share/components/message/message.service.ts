...
import { ApplicationRef, ComponentFactoryResolver, ComponentRef, Inject, Injectable, Injector, PLATFORM_ID, Renderer2, RendererFactory2, TemplateRef } from '@angular/core';
import { uniqueId } from 'lodash';
import { Subject } from 'rxjs';
import { MessageComponent } from './message.component';
import { MessageModule } from './message.module';
import { XmMessageOptions, XmMessageItemData } from './types';
...
export class MessageService {
  ...
  private create(content: string | TemplateRef<void>,options?:XmMessageOptions):XmMessageItemData{
    ...
    if(isPlatformBrowser(this.platformId)){
      ...
      this.message.createMessge(messageItemData);
